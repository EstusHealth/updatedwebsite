...
const DOMAINS = [
  ...
  },
  {
    ...
    terms: [
      ...
      { t: 'PDA', d: 'Originally "Pathological Demand Avoidance", increasingly reframed by the autistic community as Persistent (or Pervasive) Drive for Autonomy: a profile involving an anxiety-driven, nervous-system need for autonomy and intense resistance to everyday demands.', care: 'Terminology is genuinely contested; it is recognised mainly in the UK and is not a standalone DSM-5 diagnosis.' },
