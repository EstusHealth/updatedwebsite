                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: "8px",
                        backgroundColor: selected ? 'rgba(28,232,240,.10)' : t.bg,
                        cursor: "pointer",
        ...
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "3rem 1.5rem 6rem" }}>
          ...
          >
            ...
            {result.primary.tips.map((tip, i) => (
              ...
              >
                ...
                <p style={{ fontSize: "0.95rem", lineHeight: 1.65, color: 'var(--text-soft)' }}>
                  {tip}
                </p>
              </div>
            ))}
          ...
          {result.secondary && (
            ...
            >
              ...
              <p style={{ fontSize: "0.95rem", lineHeight: 1.6, color: 'var(--text-soft)' }}>
          ...
          >
            ...
            <p style={{ fontSize: "1rem", lineHeight: 1.7, color: 'var(--text-soft)' }}>
