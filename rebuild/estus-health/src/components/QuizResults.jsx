...
/*
  Color constants remapped to the neon design tokens.
*/
const C = {
  bg: 'var(--bg)',
  fg: 'var(--text)',
  card: 'var(--surface)',
  primary: 'var(--teal)',
  primaryFg: 'var(--btn-text)',
  secondary: 'var(--surface-2)',
  border: 'var(--line)',
  muted: 'var(--text-soft)',
  heroCenter: 'var(--navy)',
  heroEdge: 'var(--band-bg)',
  heroText: '#ffffff', // hero + final-CTA bands are always dark; text stays light in both themes
};
                ...
                >
                  <div
                    style={{
                      height: '100%',
                      borderRadius: '4px',
                      background: isPrimary ? C.primary : 'rgba(28,232,240,.4)',
                      width: `${pct}%`,
